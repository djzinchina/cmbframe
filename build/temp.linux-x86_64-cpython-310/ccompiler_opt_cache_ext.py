...
{'cache_infile': False,
 'cache_me': {"('cc_test_flags', ['-O3'])": False,
              ...
              "('cc_test_flags', ['-mpopcnt'])": False,
              "('cc_test_flags', ['-msse'])": False,
              "('cc_test_flags', ['-msse2'])": False,
              "('cc_test_flags', ['-msse3'])": False,
              "('cc_test_flags', ['-msse4.1'])": False,
              "('cc_test_flags', ['-msse4.2'])": False,
              "('cc_test_flags', ['-mssse3'])": False,
              "('feature_flags', 'SSE')": [],
              "('feature_flags', 'SSE2')": [],
              "('feature_flags', 'SSE42')": [],
              "('feature_flags', set())": [],
