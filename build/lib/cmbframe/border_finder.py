...
def get_mask_border(mask_in, need_nos=False):
    ...
    # For intermediate cases
        ...
        mask_lm = hp.map2alm(mask_in, pol=False, use_weights=True, datapath='/home/doujzh/Healpix_3.70/data')
        mask_lm_sm = hp.smoothalm(mask_lm, fwhm=(np.sqrt(2.) * pixsize), pol=False, verbose=False)
        smooth_mask = hp.alm2map(mask_lm_sm, nside, pol=False, verbose=False)
