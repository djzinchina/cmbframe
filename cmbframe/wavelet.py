...
def map2wavelet(map_in, bands, wavelet_nside=None, nodegrade=False, w_nside_min=None, w_nside_max=None):
    ...
    alm_temp = hp.map2alm(map_in, lmax=lmax_sht, pol=False, use_weights=True, datapath='/home/doujzh/Healpix_3.70/data')
...
def wavelet2alm(wvlt_map_in, bands):
    ...
    for band in range(nbands):
        ...
        alm_band = hp.map2alm(np.copy(wvlt_map_in[band]),lmax=lmax_band, pol=False, use_weights=True, datapath="/home/doujzh/Healpix_3.70/data")
